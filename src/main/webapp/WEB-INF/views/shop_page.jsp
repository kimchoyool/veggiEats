...
<head>
<meta charset="UTF-8">
<link href="${context}/common/css/detailed.css" rel="stylesheet" media="all">

<title>상세페이지</title>
<link rel="stylesheet" href="${context}/bootstrap_css/bootstrap.min.css">
</head> 
<body>
	<main id="contents_d">
		<section id="detailed">
			<div id="shop_info" class="info">
				<div id="shop_images" class="info">
					<img src="${context}/common/img/연남 플랜트외관.jpg" height="300px">
					<img src="${context}/common/img/연남 플랜트3.jpg" height="300px">
				</div>
				<div class="shop_common info" align="right"><!-- 좋아요, 공유하기 등 -->
					<img id="heart" src="${context}/common/img/heart_solid.png">
					<img src="${context}/common/img/share-nodes-solid.svg">
				</div>
				...
				<div class="info"><!-- 기본정보 메뉴 사진 후기 -->
					...
					<div id="detailed_page"> <!-- 기본정보 -->
						...
						<div><div><img src="${context}/common/img/geo-alt.svg" width="20px">주소</div><div>서울 마포구 월드컵북로4길 87</div></div>
						<div><div><img src="${context}/common/img/clock.svg" width="20px">영업시간</div><div>11:00~22:00</div></div>
						<div><div><img src="${context}/common/img/battery-charging.svg" width="20px">정기휴무</div><div>매주 월요일</div></div>
						<div><div><img src="${context}/common/img/telephone.svg" width="20px">연락처</div><div>02-337-1982</div></div>
					</div>
					...
					<div id="detailed_photo"><!-- 사진 -->
						...
						<img src="${context}/common/img/연남 플랜트1.jpg">
						<img src="${context}/common/img/연남 플랜트2.jpg">
						<img src="${context}/common/img/연남 플랜트3.jpg">
						<img src="${context}/common/img/연남 플랜트4.jpg">
						<img src="${context}/common/img/연남 플랜트5.jpg">

					</div>
					<div id="detailed_review"><!-- 후기 -->
						<div class="title">후기</div>
						<div>
							<img src="${context}/common/img/user-regular.svg" width="20px"> 러브비건 
							<span>너무 맛있어요 양도 많고 후무스 샐러드가 진짜 맛있습니다!!</span>
						</div>
						<div>
							<img src="${context}/common/img/user-regular.svg" width="20px"> 러브비건2
		...
		<form id="form" name="reservation" onsubmit="return chk()" action="${context}/reservation.do" method="post">
			<div id="calendar">
				<div id="calendar_ymb">
					<button type="button" id="prev" onmouseover="prev_mouseover()" onmouseleave="prev_mouseleave()"><img id="prev_img" src="${context}/common/img/caret-left.svg"></button>
					<p></p>
					<button type="button" id="next" onmouseover="next_mouseover()" onmouseleave="next_mouseleave()"><img id="next_img" src="${context}/common/img/caret-right.svg"></button>
				</div>
				<table></table>
			</div>
...
<!-- footer -->
	<div id="div_up_arrow">
		<a href="#contents_d"><img id="up_arrow" src="http://localhost:8080/VeggiEats/common/img/arrow-up-circle.svg"></a>
	</div>	 
	<script type="text/javascript" src="${context}/common/js/jquery-3.6.4.js"></script>
	<script type="text/javascript" src="${context}/common/bootstrap_js/bootstrap.min.js"></script>
	<script type="text/javascript" src="${context}/common/js/calendar.js?v=<%=System.currentTimeMillis() %>"></script>
